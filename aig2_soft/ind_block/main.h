...
#define DE_ON GPIO_SetBits(GPIOA,GPIO_Pin_12)
#define DE_OFF GPIO_ResetBits(GPIOA,GPIO_Pin_12)

#define RE_ON GPIO_ResetBits(GPIOA,GPIO_Pin_11)
#define RE_OFF GPIO_SetBits(GPIOA,GPIO_Pin_11)
...
#define LCD_LIGHT_OFF GPIO_SetBits(GPIOA,GPIO_Pin_15)
#define LCD_LIGHT_ON  GPIO_ResetBits(GPIOA,GPIO_Pin_15)

#define BUT_PRESS (!GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_12))
