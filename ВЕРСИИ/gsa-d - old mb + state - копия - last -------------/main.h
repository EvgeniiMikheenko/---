...
#define FLASH_LOCATION_2			((u32)0x08008400-FLASH_PAGE_SIZE)
#define EndAddr_2					((u32)0x08008400)
#define FLASH_SIZE_2				(((unsigned short *)&Net_Params.crc2 - (unsigned short *) & Net_Params)/2+1)
//#define FLASH_SIZE_2				(((unsigned short *)&Params.crc2 - (unsigned short *) & Params.Device)/2+1)
