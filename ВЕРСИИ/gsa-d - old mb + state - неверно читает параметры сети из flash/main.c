...
int main(void)
{
	...
	//////////////////////////////////////////////////////////////////////////////////////////////
//	Params.Set[0].Pos_Tresh = 0x111;							/////   Убрать это немедленно!
//	Params.Set[0].Neg_Tresh = 0x112;
//	Params.Set[0].Pos_Tresh_Danger = 0x113;
//	Params.Set[0].Neg_Tresh_Danger = 0x114;
//	
//	
//	Params.Temp_Int = 0x001;
//	Params.Ass = 0x002;
//	Params.HV = 0x003;
//	Params.Pos_Value = 0x004;
//	Params.Neg_Value = 0x005;
//	
	//////////////////////////////////////////////////////////////////////////////////////////////
	while (1)
	{
...
//		return;
	...
	////////////////////////////////////////			//добавить запись регистров 100 - 104
...
int FlashRestore( void )
{
	...
	//чтение данных в регистры 100 - 104
...
void USART1_IRQHandler(void)
{
	...
	switch (stat)
	{
		...
		case 0x4:
			...
			{
				case 0:
					if (in_byte == MB_ADDR || in_byte == MB_ADDR_REQUEST)
						mb_addr = in_byte;
					else
						mb_sl_bytecount = - 1;
					break;
